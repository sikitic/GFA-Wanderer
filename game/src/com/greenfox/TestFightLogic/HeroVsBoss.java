...
public class HeroVsBoss {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfFights; i++) {
            ...
            int creatureDefendPoint = creatureLevel + 1;
...
//               System.out.println("creature " + creatureCurrentHealthPoint);
        ...
        System.out.println(creatureLevel + " lvl boss wins in " + (double) creatureCounter / (numberOfFights / 100) + "%");
